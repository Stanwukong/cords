...
import { TiLocationArrow, TiThListOutline } from "react-icons/ti";
        ...
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-6">
          ...
          <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
            <BentoCard
              ...
              description="A gamified social hub, adding a new dimension of play to social interaction for Web3 commnunities."
            />
          </BentoTilt>
